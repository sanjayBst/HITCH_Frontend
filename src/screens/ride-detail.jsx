    ...
    <div className="max-w-[1080px] mx-auto px-7 pt-10 pb-20 md:px-4 md:pt-6">
      ...
      <div className="grid grid-cols-[1.4fr_1fr] gap-7 items-start md:grid-cols-1">
        <div className="flex flex-col gap-5">
          ...
          {ride.note && (
            <div className="card-base p-6">
              <div className="font-mono text-[11px] tracking-widest uppercase text-ink-3 mb-2">Driver's note</div>
        ...
        <div className="flex flex-col gap-5 sticky top-[84px] md:relative md:top-0">
          {isMine ? (
            <div className="card-base p-6">
              ...
              <h3 className="m-0 mb-3.5 font-semibold tracking-tight">You're driving this one.</h3>
              <div className="text-ink-3 text-[13px] mb-[18px]">
                Riders nearby can see your slot and send requests. You'll be notified — accept or reject before <span className="font-mono text-ink">1 hour</span> of departure.
              </div>
            ...
            <div className="card-base p-6">
              ...
              <div className="text-ink-3 text-[13px] mb-[18px]">
                Hitch is non-commercial. No money, no commission. {departHrs >= 1 ? <>Driver has until <span className="font-mono text-ink">1h before departure</span> to accept.</> : <>Less than an hour to go — driver may not be able to accept.</>}
              </div>
